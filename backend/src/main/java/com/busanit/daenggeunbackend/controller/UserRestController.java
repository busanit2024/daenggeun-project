...
public class UserRestController {
    ...
    @PatchMapping("/{uid}/location")
    public ResponseEntity<User> updateLocation(
        @PathVariable String uid,
        @RequestBody Map<String, List<Location>> request
    ) {
        List<Location> locations = request.get("location");
        User updatedUser = userService.updateLocation(uid, locations);
